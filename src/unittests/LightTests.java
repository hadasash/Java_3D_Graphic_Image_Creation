...
public class LightTests 
{
	...
	public void trianglesDirectional() {
		scene2.geometries.add(triangle1.setMaterial(new Material().set_kD(0.8).set_kS(0.2).set_nShininess(300)), //
				triangle2.setMaterial(new Material().set_kD(0.8).set_kS(0.2).set_nShininess(300)));
	...
	public void trianglesPoint() {
		scene2.geometries.add(triangle1.setMaterial(new Material().set_kD(0.5).set_kS(0.5).set_nShininess(300)), //
				triangle2.setMaterial(new Material().set_kD(0.5).set_kS(0.5).set_nShininess(300)));
	...
	public void trianglesLights() 
	{
		...
		ImageWriter imageWriter = new ImageWriter("AllLightsTriangle", 500, 500);
		Render render = new Render()//
				.setImageWriter(imageWriter) //
				.setCamera(camera2) //
				.setRayTracerBase(new RayTracerBasic(scene2));
