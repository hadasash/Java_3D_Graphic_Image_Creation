...
{  
	...
	public void findIntersections() {
		try {
			...
			// BVA: Starting point of the ray is on the plane, but the vector is not included in the plane
			...
			// BVA: Starting point of the ray is equal to the point represents the plane- q0
